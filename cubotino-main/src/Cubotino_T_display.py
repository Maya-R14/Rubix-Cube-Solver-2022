...
"""
#This file is largely unecessary as the robot lacks display, but since code still runts through this file. It would return an error
the file was removed all together. 
"""
...
class Display:
    def __init__(self):
        ...
        # convenient choice, to upload the settings fitting my robot
